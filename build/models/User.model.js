...
let User = class User {
    constructor(email, firstName, lastName, password, verificationCode, passwordResetCode, verified) {
        this.email = email;
...
exports.User = User = __decorate([
    ...
    __metadata("design:paramtypes", [String, String, String, String, String, Object, Boolean])
], User);
